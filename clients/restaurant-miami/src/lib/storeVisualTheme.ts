...
const VISUAL_THEMES: Record<StoreThemeId, VisualTheme> = {
  ...
  luxeGraphite: { id: "luxeGraphite", label: "Luxe Graphite", accent: "#111827", secondary: "#d4a017", surface: "#f4f5f7", page: "#eceff3", dark: "#07090e", text: "#1f2937", muted: "#64748b" },
  velvetRose: { id: "velvetRose", label: "Velvet Rose", accent: "#be185d", secondary: "#fb7185", surface: "#fff1f2", page: "#ffe4ea", dark: "#140a12", text: "#3f102a", muted: "#9f1239" },
  oceanicTech: { id: "oceanicTech", label: "Oceanic Tech", accent: "#0e7490", secondary: "#2563eb", surface: "#eef8ff", page: "#e0edf9", dark: "#04111b", text: "#0f172a", muted: "#334155" },
  forestMarket: { id: "forestMarket", label: "Forest Market", accent: "#15803d", secondary: "#65a30d", surface: "#f1fdf4", page: "#e7f7ec", dark: "#06150f", text: "#0f2c1f", muted: "#365948" },
  sunsetStudio: { id: "sunsetStudio", label: "Sunset Studio", accent: "#ea580c", secondary: "#f59e0b", surface: "#fff7ed", page: "#ffedd5", dark: "#1a0f0b", text: "#3a1d0f", muted: "#7c3f1f" },
