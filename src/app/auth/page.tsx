    ...
    () =>
      isEnglish
        ...
        : {
            ...
            loginTab: "Iniciar SesiÃ³n",
            registerTab: "Registrarse",
            labelName: "Nombre",
            labelEmail: "Email",
            labelPassword: "ContraseÃ±a",
            labelReferral: "CÃ³digo o alias de referido (opcional)",
            placeholderName: "Tu nombre",
            placeholderEmail: "tucorreo@dominio.com",
            placeholderReferral: "Ejemplo: FASTAB12 o gozustrike",
            referralLockedHint: "Referido bloqueado desde enlace de invitaciÃ³n.",
            forgotPassword: "Â¿Olvidaste tu contraseÃ±a?",
            submitLogin: "Entrar",
            submitRegister: "Crear cuenta",
            fillAllFields: "Completa todos los campos",
            accountCreated: "Â¡Cuenta creada exitosamente!",
            emailInUse: "El email ya estÃ¡ registrado",
            weakPassword: "La contraseÃ±a es muy dÃ©bil (mÃ­nimo 6 caracteres)",
            authNotEnabled:
              "Error de configuraciÃ³n: habilita Authentication en Firebase Console",
            genericError: "Error:",
            enterCredentials: "Ingresa email y contraseÃ±a",
            useGoogle: "Usa Google. Tu cuenta estÃ¡ vinculada a Google.",
            invalidCredentials:
              "Credenciales invÃ¡lidas. Si usaste Google, usa el botÃ³n de abajo.",
            loginError: "Error al iniciar sesiÃ³n:",
            redirectGoogle: "Redirigiendo para iniciar sesiÃ³n con Google...",
            ...
            popupBlocked: "El navegador bloqueÃ³ la ventana emergente. Por favor, habilÃ­tala.",
            loginCancelled: "Inicio de sesiÃ³n cancelado.",
            ...
            recoverySent: "Te enviamos un correo para restablecer tu contraseÃ±a.",
            invalidEmail: "El correo no es vÃ¡lido.",
            accountNotFound: "No existe una cuenta con ese correo.",
            recoveryFailed: "No se pudo enviar el correo de recuperaciÃ³n.",
            continueWith: "O continÃºa con",
            continueGoogle: "Continuar con Google",
            recoverButton: "Â¿Olvidaste tu contraseÃ±a? Recuperar",
